<?php
// src/Zlab/JobeetBundle/DataFixtures/ORM/LoadJobData.php
namespace Zlab\JobeetBundle\DataFixtures\ORM;
...
class LoadJobData extends AbstractFixture implements OrderedFixtureInterface
{
  public function load(ObjectManager $em)
  {
    ...
    //$job_sensio_labs->setUpdatedAt($this->getCreatedAt());
    ...
    $job_extreme_sensio->setDescription('Questo è creato oggi. <br>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in.');
    ...
    $job_extreme_sensio->setCreatedAt(new \DateTime(date('Y-m-d H:i:s', time() - 86400 * 7)));
    //$job_extreme_sensio->setUpdatedAt($this->getCreatedAt());
    ...
    $job_expired->setCreatedAt(new \DateTime('2013-01-01'));
